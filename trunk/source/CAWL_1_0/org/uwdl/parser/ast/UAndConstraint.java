...
public class UAndConstraint extends URuleDescendant {
	final UConstraint constraint;
//	final LogicTag logicTag;
	
	public UAndConstraint(XMLAttributeMap map, USubject subject, UVerb verb, UObject object) throws uWDLMissingRequiredAttributeException {
		super(Tag.Constraint);
		// TODO Auto-generated constructor stub
	//	this.logicTag = LogicTag.AND;
