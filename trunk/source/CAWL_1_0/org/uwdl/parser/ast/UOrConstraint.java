...
public class UOrConstraint extends URuleDescendant {
	private final UConstraint constraint;
	//private final LogicTag logicTag;
	
	public UOrConstraint(XMLAttributeMap map, USubject subject, UVerb verb, UObject object) throws uWDLMissingRequiredAttributeException {
		super(Tag.Constraint);
		// TODO Auto-generated constructor stub
	//	this.logicTag = LogicTag.OR; 
